...
- **新增节点位置**：人工点击 palette 新增节点时，节点出现在当前画布可见区域中心附近；连续点击同类或不同类节点会做小幅错位，避免完全重叠导致用户找不到新节点。自动化 / WebMCP 工具仍按 [06](06_webmcp_tools.md) 的确定性布局规则处理坐标。
